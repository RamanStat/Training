...
namespace Training.RA.Migrations
{
    ...
    [Migration("20210416101447_RemovedAutoparts")]
    partial class RemovedAutoparts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Training.Data.Entities.Autopart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Training.Data.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Training.Data.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Training.Data.Entities.Producer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Training.Data.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AutopartCar", b =>
                {
                    b.HasOne("Training.Data.Entities.Autopart", null)
                        .WithMany()
                        .HasForeignKey("AutopartsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Training.Data.Entities.Car", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AutopartVendor", b =>
                {
                    ...
                    b.HasOne("Training.Data.Entities.Vendor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Training.Data.Entities.Autopart", b =>
                {
                    b.HasOne("Training.Data.Entities.Producer", "Producer")
                        .WithMany("Autoparts")
            ...
            modelBuilder.Entity("Training.Data.Entities.Order", b =>
                {
                    b.HasOne("Training.Data.Entities.Autopart", "Autopart")
                        .WithMany()
                        .HasForeignKey("AutopartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Training.Data.Entities.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Training.Data.Entities.Client", "Client")
                        .WithMany("Orders")
